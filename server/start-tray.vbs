' Silent launcher: starts the manga-yomi OCR server as a tray icon,
...
If Not fso.FileExists(here & "\venv\Scripts\pythonw.exe") Then
    MsgBox "venv not found - run run-server.bat once first to install dependencies.", 48, "manga-yomi"
    WScript.Quit 1
End If
